...
exports.ComplianceCommand = void 0;
    ...
    try {
        ...
        const results = [
            {
                ...
                compliance: {
                    ...
                    checks: [
                        { name: 'Data Protection', status: 'pass', score: 90, details: 'GDPR compliant' },
                        { name: 'Access Control', status: 'pass', score: 80, details: 'Basic auth implemented' },
                        { name: 'Audit Logging', status: 'warning', score: 75, details: 'Limited retention period' }
                    ]
                }
            },
            {
                ...
                compliance: {
                    ...
                    lastChecked: new Date(),
                    checks: [
                        { name: 'Data Protection', status: 'pass', score: 95, details: 'Comprehensive encryption' },
                        { name: 'Access Control', status: 'pass', score: 90, details: 'Multi-factor auth' },
                        { name: 'Audit Logging', status: 'pass', score: 92, details: 'Full audit trail' }
                    ]
                }
            }
        ];
        if (options.json) {
            ...
            results.forEach(result => {
                ...
                const failedChecks = result.compliance.checks.filter((c) => c.status === 'fail');
...
exports.ComplianceCommand = ComplianceCommand;
